        ...
        <div class="screen active p-4 md:p-8 max-w-5xl mx-auto">
             <div class="bg-white p-8 rounded-2xl shadow-lg">
                ...
                <div class="text-center text-slate-500 py-16">
                    ...
                    <h3 class="mt-2 text-sm font-medium text-gray-900">Tidak ada laporan untuk ditampilkan</h3>
                    <p class="mt-1 text-sm text-gray-500">Fitur laporan sedang dalam pengembangan.</p>
                </div>
             </div>
        </div>`;
    },
