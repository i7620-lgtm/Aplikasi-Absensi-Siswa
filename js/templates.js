        ...
        <div class="screen active min-h-screen flex flex-col items-center justify-center p-4">
            <div class="bg-white p-8 rounded-2xl shadow-lg w-full max-w-[95%] xl:max-w-[1400px]">
                ...
                <div class="mt-8">
                    ...
                    <button id="request-teacher-access-btn" class="w-full h-full bg-slate-100 hover:bg-slate-200 text-slate-700 font-bold py-4 px-6 rounded-lg transition flex items-center gap-4 text-left border border-slate-300">
                        <svg class="w-8 h-8 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
                        <div><p class="font-bold">Akses Tenaga Pendidik</p><p class="text-sm font-normal opacity-90">Daftarkan diri Anda sebagai staf/guru sekolah.</p></div>
                    </button>
                    ` : ''}
            ...
            <div class="w-full max-w-[95%] xl:max-w-[1400px] mx-auto bg-white rounded-xl shadow-lg overflow-hidden min-h-[600px] flex flex-col">
                 <div class="p-6 border-b border-slate-100 flex flex-col md:flex-row justify-between items-center gap-4 bg-slate-50">
                    ...
                    <div class="flex items-center gap-4 flex-wrap">
                        <div class="relative">
                            <input type="text" id="admin-search-input" placeholder="Cari nama atau email..." class="pl-10 pr-4 py-2 border rounded-lg text-sm focus:ring-blue-500 focus:border-blue-500 w-64">
